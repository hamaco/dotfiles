...
"url":"^https?://(?:api\\.)?twitter\\.com/(?:(?:[^/]+/)?follow(?:ers|ing)|[^/]+/[^/]+/(?:members|subscribers))",
...
{
"pageElement":"//td/div[contains(@class,\"listitem\")] | //div[contains(@class,\"contents_list\") or contains(@class,\"gsc-webResult\")] | //div[contains(@class,\"pager\")]/following-sibling::dl | id(\"article\")/*",
...
{
"pageElement":" tid(\"contents_body\") | //img[contains(@src, \"title.jpg\")]/../../following-sibling::tr[following::img[contains(@src, \"try_next.gif\") or contains(@src, \"try_back.gif\")]]",
...
{
"pageElement":"id(\"body\")/*[not(@id=\"nextpage\")]",
"url":"^http://www\\.theregister\\.co\\.uk/(?:\\d+/){3}.",
"nextLink":"id(\"nextpage\")/a"
},
{
...
"url":"^http://addons\\.miranda-im\\.org/index\\.php\\?",
...
"nextLink":"//td[@class=\"contentheadings\"]/*[self::strong or self::b]/following-sibling::a[1]"
},
{
"pageElement":"id(\"Main\")/div[@class=\"post\"]",
...
"nextLink":"id(\"art-pag\")//a[text()=\"NEXT\"]"
},
{
...
{
"insertBefore":"'div(\"listArea\")/following-sibling::node()',",
"pageElement":"'div(\"listArea\")',",
...
{
"pageElement":"//form[@action=\"futaba.php\"]",
