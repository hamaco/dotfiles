...
alias d-npm16='docker run --rm -it -v $(pwd):/app -w /app node:16 npm'
alias d-yarn='docker run --rm -it -v $(pwd):/app -w /app node yarn'
alias d-yarn10='docker run --rm -it -v $(pwd):/app -w /app node:10 yarn'
alias d-yarn12='docker run --rm -it -v $(pwd):/app -w /app node:12 yarn'
alias d-yarn14='docker run --rm -it -v $(pwd):/app -w /app node:14 yarn'
alias d-yarn16='docker run --rm -it -v $(pwd):/app -w /app node:16 yarn'
